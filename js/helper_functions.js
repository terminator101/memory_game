$(document).ready(function(){
	...
	/*var theDialog = new dialog('playerEntry');
	theDialog.addDialogElements();
	theDialog.execute();
	$('#result').hide();*/
	...
	var game = new memoryGame();
		...
		/*$('#result').hide();
		$('#playerEntry').hide();
		var thePlayer = new player(0,'Andrej');
		thePlayer.setPlayerCssClass("player0color");
		var thePlayerArray = [thePlayer];
		game.setParamethers(4,'Grampa dog',thePlayerArray,'#playerHolder');
		game.execute();*/

	//$('#playerEntry').hide();

	//var newPlayer = theDialog.addPlayer(2,1,"computer");
	//$('#result').show();
	//used for testing 18, 24
	/*var thePlayer = new player(0,'Andrej',true);
		thePlayer.setPlayerCssClass("player0color");
	var thePlayer2 = new player(1,'Lee',true);
		thePlayer2.setPlayerCssClass("player1color");
	var thePlayer3 = new player(2,'Mike',true);
		thePlayer3.setPlayerCssClass("player2color");
	var thePlayer4 = new player(3,'Jesse',true);
		thePlayer4.setPlayerCssClass("player3color");
	var thePlayerArray = [thePlayer,thePlayer2,thePlayer3,thePlayer4];

	var game = new memoryGame();
		game.setParamethers(6,'Grampa dog',thePlayerArray,'#playerHolder')
		game.execute();*/
	/*setTimeout(function(){
...
/*	var thePlayer = new player(0,'Andrej');
	...
	/* Not backwards compatibe
	var game = new memoryGame('2','grampa',{ 
		players: thePlayerArray,
		contaierId: '#playerHolder'
	});*/
	

		/*game.createCards();
		game.storePlayers(thePlayerArray);
		game.addToPlayerContainer('#playerHolder');*/
		//$("#rematchGame").click();
});
